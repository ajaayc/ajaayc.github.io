...
export default function MDOTLaneMarkingContent() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <p>
        As a research assistant at the University of Michigan Transportation Research Institute in Ann Arbor, MI, I worked under Dr. <a href="https://sites.google.com/view/danielpark/home" className="text-blue-600 font-semibold hover:underline">Daniel Park</a> on a project to evaluate the effectiveness of various road lane marking materials. The project was funded by the Michigan Department of Transportation (MDOT).
      </p>

      <p>
        In 2017, a section of the US-23 highway between Ann Arbor, MI and Brighton, MI was paved with different lane marking materials along different stretches. We planned to perform a study over a 2-year period to determine how well each lane marking material on the highway lasted over time; we expected that the different stretches of the highway would be impacted similarly by various environmental factors, such as temperature and precipitation.
      </p>

      <p>
        To achieve our goal we required a method to take measurements of the lane markings' conditions on the US-23 highway once during each month so that after the 2-year period we could retrospectively analyze how the lane markings' conditions changed over time. Our solution to this problem was to equip a Honda Accord car with various sensors, including:
      </p>
      ...
      <p>
        For this project, I developed multi-threaded C++ code utilizing the VTK and PCL libraries to extract, interpret, and visualize data collected from our Lidar. We experimented with two Lidar's: The Quanergy M-8 and the Velodyne HDL-64E. Each of these Lidars outputs [x,y,z] point clouds of their surroundings as well as point <a href="http://desktop.arcgis.com/en/arcmap/10.3/manage-data/las-dataset/what-is-intensity-data-.htm" className="text-blue-600 font-semibold hover:underline">intensities</a>. We were mostly interested in examining the point intensity measurements of the lane markings. In theory, we could see how the intensity values of the points representing lane markings changed over time. The degradation of the highway pavement by the Michigan weather would result in lower intensity points returned by the Lidar for various lane marking materials.
      </p>

      <p>
        I also developed C++ code to interface with our car's Mobileye unit via the vehicle's CAN message network. The Mobileye communicated data regarding the status of the left and right lane markings on the road in front of the driver. Its data arrived in real time as a sequence of bytes that needed to be converted into a human readable format.
      </p>
