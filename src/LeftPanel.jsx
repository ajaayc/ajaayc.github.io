  ...
  return (
    <aside className="flex flex-col w-full h-auto md:h-full p-6">
      ...
      <div className="flex gap-4 mt-4">
        <a href="https://github.com/ajaayc" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-green-600">
          <FaGithub size={iconSize} />
        </a>
        <a href="https://www.youtube.com/@ajaaychandrasekaran2002" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-green-600">
          <FaYoutube size={iconSize} />
        </a>
        <a href="https://www.linkedin.com/in/ajaayc" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-green-600">
